#ifndef __DRAWING_UTILITIES_H__
#define __DRAWING_UTILITIES_H__
...
class TextureMap
{
    public:
        ...
        void drawDimetric( const Vector2Df &world_position, const float height = 0.0f ) const;
